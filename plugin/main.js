...
function add_css(target) {
  append_styles(target, "svelte-1bzi045", ".number.svelte-1bzi045{color:red}");
}
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      t2 = text("!");
      attr(div, "class", "number svelte-1bzi045");
    },
    m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("variable" in $$props2)
      $$invalidate(0, variable = $$props2.variable);
  };
  return [variable];
}
var MyComponent = class extends SvelteComponent {
  constructor(options) {
    super();
...
var MyView = class extends import_obsidian.ItemView {
  constructor(leaf) {
    super(leaf);
  ...
  async onOpen() {
    this.component = new MyComponent_default({
